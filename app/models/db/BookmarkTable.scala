...
trait BookmarkTable {
  ...
  class Bookmarks(_tableTag: Tag) extends Table[BookmarksRow](_tableTag, "bookmarks") {
    ...
    def * = {
      (id, title, summary, notes, authorid, rating, date, categories, tags, warnings, fandoms, characters,
    ...
    def ? = {
      (Rep.Some(id), Rep.Some(title), summary, notes, Rep.Some(authorid), Rep
        .Some(rating), date, categories, tags, warnings, fandoms, characters, relationships, url, Rep
        .Some(imported), Rep.Some(donotimport), ao3url)
        .shaped.<>({ r => import r._;
        _1.map(_ => BookmarksRow.tupled((_1.get, _2.get, _3, _4, _5.get, _6
          .get, _7, _8, _9, _10, _11, _12, _13, _14, _15.get, _16.get, _17)))
